...
<div className="flex flex-col lg:flex-row h-full w-full justify-around 2xl:max-w-7xl lg:max-w-6xl lg:mx-auto mt-10 ">
        ...
        <div className="xl:h-[70vh]  h-full lg:w-[90%] rounded-xl flex flex-col justify-start items-left bg-slate-800 py-10 shadow-2xl shadow-slate-500 lg:mt-5 2xl:pb-20 lg:pb-14 mx-1 lg:mx-0 my-5 lg:my-0 ">
        ...
        <div className=" xl:h-[70vh] lg:w-[90%] h-full  rounded-xl flex flex-col justify-start items-left bg-slate-800 py-10 shadow-2xl shadow-slate-500 2xl:mt-10 mx-1 xl:mt-5 lg:pb-16 lg:mx-0 my-5 lg:my-0  ">
