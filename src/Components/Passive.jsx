...
<div className="flex flex-col lg:flex-row h-full w-full justify-around 2xl:max-w-7xl lg:max-w-6xl lg:mx-auto mt-10 ">
        ...
        <div className="h-[95%] lg:w-[90%] rounded-xl flex flex-col justify-start items-left bg-slate-800 py-10 shadow-2xl shadow-slate-500 lg:mt-10 2xl:pb-20 lg:pb-14 mx-1 lg:mx-0 my-5 lg:my-0 ">
        ...
        <div className="lg:w-[100%]  h-full  rounded-xl flex flex-col justify-start items-left bg-slate-800 py-10 shadow-2xl shadow-slate-500 mx-1 lg:mx-0 my-5 lg:my-0  ">
          <h3 className="text-3xl  lg:text-2xl 2xl:text-3xl font-bold text-center p-5 py-5 text-slate-200 underline underline-offset-4">Residencia para profesionales con proyeccion internacional</h3>
        ...
        <div className=" h-[95%] lg:w-[90%]  rounded-xl flex flex-col justify-start items-left bg-slate-800 py-10 shadow-2xl shadow-slate-500 2xl:mt-10 mx-1 lg:mx-0 my-5 lg:my-0  ">
