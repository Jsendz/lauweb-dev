...
const Servicios = () => {
  return (
    ...
    <div className=" shadow-2xl rounded-xl bg-white lg:-mt-24 2xl:-mt-28  hover:bg-slate-900 hover:text-white m-2 lg:m-0 lg:w-[30%]"><div className="p-5 w-full h-full flex flex-col justify-evenly items-center "><img src="src/assets/empresa2.png" alt="" className="mx-auto w-[60%] h-[100%]"/><h3 className="text-xl font-extrabold py-2">Empresa</h3>
