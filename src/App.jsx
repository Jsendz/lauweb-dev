...
<div className="bg-[url('/src/assets/blue.png')] bg-cover  w-full h-screen p-0">
        <div className="text-center h-[250px] flex flex-col justify-around items-center pt-16 ">
            <h1 className="text-7xl font-extrabold text-white drop-shadow-lg shadow-black ">Hilltop Agency</h1>
            <h2 className="text-4xl font-extrabold text-red-300 pt-16">Pagina web en construccion....</h2>
        </div>
        <section class="pt-16">
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div class="mx-auto max-w-screen-md sm:text-center">
          <h2 class="mb-4 text-3xl tracking-tight font-extrabold text-gray-900 sm:text-4xl dark:text-white">Estamos aqui para ayudarte con lo que necesites</h2>
          <p class="mx-auto mb-8 max-w-2xl font-light text-gray-500 md:mb-12 sm:text-xl dark:text-gray-400">Ponte en contacto con nosotros y descubre nuestra amplia gama de servicios</p>
          <form action="#">
