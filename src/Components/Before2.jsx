    ...
    <div className="w-full h-full 2xl:h-[85vh] rounded-xl " >
        <div className="w-full mx-auto  lg:max-w-7xl lg:h-[70%] h-full flex flex-col lg:flex-row lg:justify-start rounded-xl lg:mb-32 xl:mb-40 " >
            <div className="w-full flex flex-col justify-center text-center lg:text-left p-2 pt-10 pl-4 lg:pl-20" >
                ...
                <h2 className="text-5xl lg:text-4xl xl:text-5xl bg-slate-700 bg-transparent pb-5 font-extrabold">Tu Agencia de Servicio Personalizado en Andorra</h2>
                ...
                <button className="p-5 bg-cyan-400 rounded-xl text-slate-800 font-semibold text-xl lg:hidden xl:block xl:w-[40%] w-1/2 mx-auto lg:mx-0">Contacta-nos</button>
