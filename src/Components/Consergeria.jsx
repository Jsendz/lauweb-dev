...
import {Key2} from '../assets/index.js';

const Consergeria = () => {
  return (
    <div className="w-full h-full lg:h-screen">
      <div className="flex flex-col lg:flex-row lg:justify-around lg:items-center mb-20">
        <div className="w-full">
        <h2 className="text-6xl font-bold text-center">Servicios y Conserjeria</h2>
        <p className="text-3xl text-center">En Hilltop Agency, entendemos que tu tiempo y tranquilidad son de gran valor. Nos
...
nuestros principales servicios:</p></div>
         <div className="w-full">
          <img src={Key2} alt=""  className="w-[350px] mx-auto"/>
         </div>
      </div>
      <div className="w-full flex flex-col lg:flex-row ">
      <div className="flex flex-col items-left justify-around rounded-lg bg-orange-400 p-5 m-2">
        <h3 className="text-xl font-extrabold text-left px-5">Trámites Administrativos</h3>
        <p className="text-left px-5">Nos encargamos de toda la burocracia y trámites administrativos que necesites realizar,
...
eficientes.</p>
      ...
      <div className="flex flex-col items-left justify-around rounded-lg bg-orange-400 p-5 m-2">
        ...
        <p className="text-left px-5">Si eres propietario de propiedades en alquiler, nos ocupamos de todo, desde la búsqueda
...
Inmuebles</h3>
        <p className="text-left px-5">Si estás planeando una reforma en tu inmueble, nosotros te acompañamos en todo el
...
establecidos.</p>
      ...
      <div className="flex flex-col items-left justify-around rounded-lg bg-orange-400 p-5 m-2">
        ...
        <p className="text-left px-5">Facilitamos tu vida diaria ocupándonos de las gestiones relacionadas con tu hogar. Desde
...
esté en orden y funcione sin contratiempos, permitiéndote disfrutar de tu hogar al máximo.</p>
      ...
      <div className="flex flex-col items-left justify-around rounded-lg bg-orange-400 p-5 m-2">
        ...
        <p className="text-left px-5">Cuando no puedas estar presente, nosotros lo estaremos por ti. Ofrecemos presencia in situ
